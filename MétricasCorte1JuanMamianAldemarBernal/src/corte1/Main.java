...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"*************************************************************************************************************************************");
		System.out.println("* Programa que retorna cuántos "
				+ "pares hay en un arreglo de tamaño n, por ejemplo, a y b, que sumados estos dos dan un número que es  * \n"
				+ "* divisible por el número preguntado por pantalla. Por ejemplo, un arreglo de [1,2,3,4,5,6], y el                                   *\n"
				+ "* número preguntado es 5, entonces las pares son [1,4] = 5, [2,3] = 5, [4,6]= 10, el resultado de                                   *\n"
				+ "* la suma de los pares dan un número que es divisible con el número preguntado en pantalla.                                         *");
		System.out.println(
				"*************************************************************************************************************************************");
		...
		// GUARDA EL NÚMERO PREGUNTADO
		System.out.print("Ingresa el número divisible: ");
		...
		for (int longitudArr = 1000; longitudArr <= 30000; longitudArr+=1000) {
			...
			// MÉTODO 1 LLAMAMOS LA FUNCIÓN Y LE PASAMOS LA LONGITUD DEL ARREGLO, EL
			...
			// MÉTODO 2 LLAMAMOS LA FUNCIÓN Y LE PASAMOS EL DIVISIBLE Y EL ARREGLO
